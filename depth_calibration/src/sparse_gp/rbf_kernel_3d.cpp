...
void rbf_kernel_3d::kernels_fast(ArrayXXd& K_dx, ArrayXXd& K_dy, const MatrixXd& X, const MatrixXd& BV)
{
...
void rbf_kernel_3d::kernel_dx(MatrixXd& k_dx, const VectorXd& x, const MatrixXd& BV)
{
...
// the differential kernel vector with respect to x
void rbf_kernel_3d::kernel_dtheta(MatrixXd& k_dtheta, const Vector3d& x, const MatrixXd& BV)
{
...
void rbf_kernel_3d::construct_covariance_fast(MatrixXd& K, const MatrixXd& X, const MatrixXd& BV)
{
...
int rbf_kernel_3d::param_size()
{
    return 2;
}

VectorXd& rbf_kernel_3d::param()
{
    return p;
}

VectorXd rbf_kernel_3d::param() const
{
    return p;
}

void rbf_kernel_3d::dKdtheta(std::vector<ArrayXXd>& Ks, const MatrixXd& BV)
{
...
//void rbf_kernel_3d::kernel_dtheta(MatrixXd& k_dtheta, )
